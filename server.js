...
/* Preconstructed messages */
var pingMsg$1 = channel.Message.encode(channel.Message.create({ ping: true })).finish();
var pongMsg$1 = channel.Message.encode(channel.Message.create({ pong: true })).finish();
/**
